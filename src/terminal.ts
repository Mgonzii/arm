...
export function sendDataToSerial(data: string): void {
  if (!port?.writable) {
    console.warn('Unable to find writable port');
    return;
  }
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  */
  ...
  // dataBitsSelector =
  //     document.getElementById('databits') as HTMLSelectElement;
  // paritySelector =
  //     document.getElementById('parity') as HTMLSelectElement;
  // stopBitsSelector =
  //     document.getElementById('stopbits') as HTMLSelectElement;
  // flowControlCheckbox =
  //     document.getElementById('rtscts') as HTMLInputElement;
  // autoconnectCheckbox =
